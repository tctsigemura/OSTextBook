...
\begin{frame}
  ...
  \tbl{scale=0.9}{schedulingObjective.pdf}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item SJFはプリエンプションなし
    \item 平均ターンアラウンド時間（$((60-0)+(90-10)+(130-60))/3=70$ ms）
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item 平均ターンアラウンド時間（$((130-0)+(50-10)+(90-60))/3=67$ ms）
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item クォンタムタイム＝10ms
    \item 平均ターンアラウンド時間（$((120-0)+(90-10)+(130-60))/3=90$）
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item クォンタムタイム＝50ms
    \item 平均ターンアラウンド時間（$((100-0)+(90-10)+(130-60))/3=83$ ms）
  \end{itemize}
\end{frame}
