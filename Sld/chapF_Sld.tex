...
\begin{frame}
  ...
  \begin{quote}
    \lst{numbers=left}{aliasOnHFS.txt}
  \end{quote}
  \begin{description}
...
\begin{frame}
  ...
  \begin{quote}
    \lst{numbers=left}{aliasOnFAT.txt}
  \end{quote}
  \begin{description}
...
\begin{frame}
  ...
  \begin{quote}
    \lst{numbers=left}{extendedAttr.txt}
  \end{quote}
  \begin{description}
...
\begin{frame}
  ...
  \fig{scale=.5}{journaling-crop.pdf}
  \begin{itemize}
