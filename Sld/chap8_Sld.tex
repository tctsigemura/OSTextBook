...
\begin{frame}
  ...
  \fig{scale=0.40}{cpuAndMemory-crop.pdf}
...
\begin{frame}
  ...
  \end{itemize}
  \fig{scale=0.60}{baseLimitRegister-crop.pdf}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \fig{scale=0.60}{lockKey-crop.pdf}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \fig{scale=0.60}{relocationRegister-crop.pdf}
\end{frame}
