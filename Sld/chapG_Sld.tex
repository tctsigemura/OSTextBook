...
\begin{frame}
  ...
  \centering{
    \begin{minipage}{0.3\columnwidth}
      \centering{\includegraphics[scale=0.8]{../Fig/hddPartition.pdf}}
    \end{minipage}
    \begin{minipage}{0.3\columnwidth}
      \centering{\includegraphics[scale=0.8]{../Fig/fatVolume.pdf}}
    \end{minipage}
    \begin{minipage}{0.3\columnwidth}
      \centering{\includegraphics[scale=0.8]{../Fig/fatBPB.pdf}}
    \end{minipage}
  }
  \vfill
  \begin{itemize}
...
\begin{frame}
  ...
  \centering{
    \begin{minipage}{0.45\columnwidth}
      \centering{\includegraphics[scale=0.9]{../Tbl/fatClsNum.pdf}}
    \end{minipage}
    \begin{minipage}{0.45\columnwidth}
      \centering{\includegraphics[scale=0.9]{../Fig/fatConcept.pdf}}
    \end{minipage}
  }
  \vfill
  \begin{itemize}
