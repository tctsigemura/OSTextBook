...
\begin{frame}
  ...
  \lst{language={Java}}{MonAccount.jama}
...
\begin{frame}
  ...
  \lst{language={Java}}{MonAccountMain.jama}
...
\begin{frame}
  ...
  \lst{language={Java},lastline=14,frame=tlr}{BoundedBuffer.jama}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=15,frame=lrb}{BoundedBuffer.jama}
...
\begin{frame}
  ...
  \lst{language={Java}}{BoundedBufferMain.jama}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=3,lastline=20,frame=tlr}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=21,lastline=36,frame=lr}
      {SemBoundedBuffer.java}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=37,lastline=49,frame=lr}
                  {SemBoundedBuffer.java}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=50,frame=lrb}{SemBoundedBuffer.java}
...
\begin{frame}
  ...
  \lst{language={Java},lastline=15,frame=tlr}{MonBoundedBuffer.java}
...
\begin{frame}
  ...
  \lst{language={Java},firstline=16,frame=rlb}{MonBoundedBuffer.java}
