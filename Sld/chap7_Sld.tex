...
\begin{frame}
  ...
  \item {\tt signal()}は状態変数の待ちスレッドを一つ起こす．
...
%=========================================================================
\begin{frame}
  \frametitle{モニタによる複数生産者と複数消費者問題の解\\（仮想言語）}
...
\begin{frame}
  \frametitle{Javaによる複数生産者と複数消費者問題の解（前半）}
...
%=========================================================================
\begin{frame}
  \frametitle{Javaによる複数生産者と複数消費者問題の解（後半）}
  ...
  \item Javaの{\tt notify()}は待ちスレッドを一つ起こす．
