...
\begin{frame}[fragile]
  ...
  \lst{language={C},lastline=18,frame=tlr}{pcb.hmm}
\end{frame}

%=========================================================================
\begin{frame}[fragile]
  \frametitle{TaCのPCB（後半）}
  \lst{language={C},firstline=20,firstnumber=20,frame=lrb}{pcb.hmm}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \lst{lastline=23,frame=tlr}{dispatch.s}
\end{frame}

%=========================================================================
\begin{frame}[fragile]
  \frametitle{プロセスの切換えプログラム（dispatch()）}
  \lst{firstline=24,firstnumber=24,frame=lrb}{dispatch.s}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \lst{language={C},lastline=21,frame=tlr}{threadTest.c}
\end{frame}

%=========================================================================
\begin{frame}[fragile]
  \frametitle{M個のスレッドで合計を計算する（後半）}
  \lst{language={C},firstline=22,firstnumber=22,frame=lrb}{threadTest.c}
\end{frame}
