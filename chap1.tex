...
\myfigure{btp}{scale=0.66}{abstruction-crop.pdf}{抽象化}{abstruction}
...
\myfigure{btp}{scale=0.66}{system-crop.pdf}{コンピュータシステムの構成}{system}
...
\myfigure{btp}{scale=0.66}{multiprogramming-crop.pdf}
...
\myfigure{btp}{scale=0.66}{timesharing-crop.pdf}
...
\myincludegraphics{tree-crop.pdf}{scale=0.6} \\
{\small
系統図は\cite{os360,
mvs,
os390,
