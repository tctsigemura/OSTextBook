...
\begin{frame}
  \frametitle{TacOSのサーバ用メッセージ通信ルーチン}
...
\begin{frame}
  \frametitle{TacOSのクライアント用メッセージ通信ルーチン}
