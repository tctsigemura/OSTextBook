...
\begin{frame}
  ...
  \lstinputlisting[lastline=17,frame=tlr]{Lst/semMultiProducerConsumer.c}
\end{frame}

\begin{frame}
  \frametitle{セマフォの使用例（複数生産者・複数消費者問題 2/2）}
  \lstinputlisting[firstline=18,frame=lrb]{Lst/semMultiProducerConsumer.c}
\end{frame}

\begin{frame}
  \frametitle{セマフォの使用例（リーダ・ライタ問題 1/2）}
  \lstinputlisting[lastline=12,frame=tlr]{Lst/semReaderWriter.c}
  {\bf 排他ロック（exclusive lock）}
\end{frame}

\begin{frame}
  \frametitle{セマフォの使用例（リーダ・ライタ問題 2/2）}
  \lstinputlisting[firstline=13,frame=lrb]{Lst/semReaderWriter.c}
...
\begin{frame}
  ...
  \lstinputlisting[lastline=19,frame=tlr]{Lst/tacosSemV.cmm}
  \begin{itemize}
...
\begin{frame}
  ...
  \lstinputlisting[firstline=20,frame=lrb]{Lst/tacosSemV.cmm}
  \begin{itemize}
